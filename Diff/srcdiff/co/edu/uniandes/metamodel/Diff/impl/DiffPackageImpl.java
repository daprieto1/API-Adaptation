/**
 */
package co.edu.uniandes.metamodel.Diff.impl;

import co.edu.uniandes.metamodel.Diff.APIElementType;
import co.edu.uniandes.metamodel.Diff.Add;
import co.edu.uniandes.metamodel.Diff.AddParameter;
import co.edu.uniandes.metamodel.Diff.AddRestriction;
import co.edu.uniandes.metamodel.Diff.AddStatusCode;
import co.edu.uniandes.metamodel.Diff.Change;
import co.edu.uniandes.metamodel.Diff.ChangeFormatReturnValue;
import co.edu.uniandes.metamodel.Diff.CombineMethods;
import co.edu.uniandes.metamodel.Diff.Complex;
import co.edu.uniandes.metamodel.Diff.ConsumeType;
import co.edu.uniandes.metamodel.Diff.DefaultClause;
import co.edu.uniandes.metamodel.Diff.DefaultValue;
import co.edu.uniandes.metamodel.Diff.Delete;
import co.edu.uniandes.metamodel.Diff.DeletePath;
import co.edu.uniandes.metamodel.Diff.Diff;
import co.edu.uniandes.metamodel.Diff.DiffFactory;
import co.edu.uniandes.metamodel.Diff.DiffPackage;
import co.edu.uniandes.metamodel.Diff.ElementReference;
import co.edu.uniandes.metamodel.Diff.ElementType;
import co.edu.uniandes.metamodel.Diff.ExposeData;
import co.edu.uniandes.metamodel.Diff.LowerBondary;
import co.edu.uniandes.metamodel.Diff.Modify;
import co.edu.uniandes.metamodel.Diff.ModifyParameterSchemaType;
import co.edu.uniandes.metamodel.Diff.MultipleParametersInOne;
import co.edu.uniandes.metamodel.Diff.ParameterLocation;
import co.edu.uniandes.metamodel.Diff.ParameterType;
import co.edu.uniandes.metamodel.Diff.ProduceType;
import co.edu.uniandes.metamodel.Diff.RefactoringType;
import co.edu.uniandes.metamodel.Diff.RelocateParameter;
import co.edu.uniandes.metamodel.Diff.RemoveParameter;
import co.edu.uniandes.metamodel.Diff.RemoveRestriction;
import co.edu.uniandes.metamodel.Diff.RemoveStatusCode;
import co.edu.uniandes.metamodel.Diff.RenameMethod;
import co.edu.uniandes.metamodel.Diff.RenameParameter;
import co.edu.uniandes.metamodel.Diff.ReturnType;
import co.edu.uniandes.metamodel.Diff.SameParameter;
import co.edu.uniandes.metamodel.Diff.Simple;
import co.edu.uniandes.metamodel.Diff.SplitMethod;
import co.edu.uniandes.metamodel.Diff.UnsupportRequestMethod;
import co.edu.uniandes.metamodel.Diff.UpperBondary;
...
public class DiffPackageImpl extends EPackageImpl implements DiffPackage {
	 ...
	 * @see co.edu.uniandes.metamodel.Diff.DiffPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
