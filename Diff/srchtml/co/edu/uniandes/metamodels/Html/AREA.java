 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.metamodels.Html.AREA#getShape <em>Shape</em>}</li>
 *   <li>{@link co.edu.uniandes.metamodels.Html.AREA#getCoords <em>Coords</em>}</li>
 *   <li>{@link co.edu.uniandes.metamodels.Html.AREA#getAhref <em>Ahref</em>}</li>
 * </ul>
 *
 * @see co.edu.uniandes.metamodels.Html.HtmlPackage#getAREA()
 * @model
 * @generated
 */
public interface AREA extends BODYElement {
	/**
